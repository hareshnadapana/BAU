module.exports = {
    ...
    findAddress: function (themeResp) {
        ...
        themeResp.data.address.forEach((element) => {
            ...
            address["pincode"] =
                element.customAddress.addressAttributes.attribute[1].attributeValue;
        ...
        if (themeResp.data.responseStatusList.status[0].statusCode == "0000") {
            if(themeResp.data.customerSubscriberSummary != null && themeResp.data.customerSubscriberSummary != undefined){
                ...
                for (let key of obj) {
                    ...
                    }else if(key == "customerid" || key == "normalName" || key == "mobilenumber" || key == "email"
