...
const customPalettes = {
    ...
    celcom_purple: generatePalette('#793680'),
    xpax_purple: generatePalette('#6A418F'),
    xpax_orange: generatePalette('#F37021'),
    axiata_blue: generatePalette('#164396'),
    axiata_gold: generatePalette('#FDB934')
};
...
const themes = {
    ...
    // },
    'celcom_purple' : {
        primary: customPalettes.celcom_purple
    },

    'xpax_purple' : {
        primary: customPalettes.xpax_purple
    },

    'xpax_orange' : {
        primary: customPalettes.xpax_orange
    },

    'axiata_blue' : {
        primary: customPalettes.axiata_blue
    },

    'axiata_gold' : {
        primary: customPalettes.axiata_gold
    }
};
