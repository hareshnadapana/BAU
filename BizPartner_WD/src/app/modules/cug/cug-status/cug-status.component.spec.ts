...
import { CugStatusComponent } from './cug-status.component';
...
describe('CugStatusComponent', () => {
  let component: CugStatusComponent;
  let fixture: ComponentFixture<CugStatusComponent>;
  let de : DebugElement;
  let el : HTMLElement;
  ...
  beforeEach( () => {
    TestBed.configureTestingModule({
      ...
      declarations: [ CugStatusComponent ]
    })
    .compileComponents();
  });
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CugStatusComponent);
