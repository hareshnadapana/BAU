...
@Component({
  selector: 'app-campaign-targeting-popup-upload',
  templateUrl: './campaign-targeting-popup-upload.component.html',
  styleUrls: ['./campaign-targeting-popup-upload.component.scss']
})
export class CampaignTargetingPopupUploadComponent implements OnInit {
  property: any[] = [
    {
      "key": "campaignname",
      "title": "Campaign Name",
  ...
  constructor(private router:Router, private route: ActivatedRoute,
    ...
    public dialogRef: MatDialogRef<CampaignTargetingPopupUploadComponent>,
  ...
  openDialog() {
    const dialogRef = this.dialog.open(CampaignTargetingPopupUploadComponent);
