...
import { UnreserveStatusComponent } from './unreserve-status.component';
...
describe('UnreserveStatusComponent', () => {
  let component: UnreserveStatusComponent;
  let fixture: ComponentFixture<UnreserveStatusComponent>;
  let de : DebugElement;
  let el : HTMLElement;
  ...
  beforeEach( () => {
    TestBed.configureTestingModule({
      ...
      declarations: [ UnreserveStatusComponent ]
    })
    .compileComponents();
  });
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(UnreserveStatusComponent);
